        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialization = table.Column<string>(type: "varchar", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Providers_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderId = table.Column<int>(type: "integer", nullable: false),
                    ServiceInfoId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_TotalPrice_Positive", "\"TotalPrice\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Bookings",
                columns: new[] { "ProviderId", "ServiceInfoId", "StartTime", "EndTime" },
                unique: true);
